...
<div class="main-content min-h-screen flex flex-col transition-all duration-300">
    <header class="h-16 md:h-20 bg-white/80 backdrop-blur-md sticky top-0 z-[210] border-b border-slate-200/60 px-4 md:px-8 flex justify-between items-center no-print">
